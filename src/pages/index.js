    ...
    return (
      <div>
        ...
        <div>
          ...
          <p style={{textAlign: 'justify'}}>
            I want to share my thoughts about programming in general. I'd like this to be my personal journal (hopefully yours too!) for whenever I or we need to recall concepts we forget.
          </p>
        </div>
